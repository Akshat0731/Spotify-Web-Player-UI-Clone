...
A Spotify-inspired web player interface built using HTML and CSS. This project was created to practice CSS layouts, Flexbox, responsive design, positioning, hover effects, and modern UI styling.
